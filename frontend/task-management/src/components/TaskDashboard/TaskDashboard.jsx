...
export default function Register() {
  ...
  const fetchTasks = async () => {
    ...
    try {
      const response = await fetch(`${config.endpoint}/task/all`, {
        method: "GET",
        headers: {
  ...
  const updateTaskStatus = async (taskId) => {
    const token = localStorage.getItem("token");
    try {
      const response = await fetch(`${config.endpoint}/task/update/${taskId}`, {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
  ...
  const deleteTask = async (taskId) => {
    const token = localStorage.getItem("token");
    try {
      const response = await fetch(`${config.endpoint}/task/delete/${taskId}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
  ...
  const handleCreateTask = async (e) => {
    ...
    const token = localStorage.getItem("token");
    try {
      const response = await fetch(`${config.endpoint}/task/new`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
